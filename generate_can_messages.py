...
import can
import time
import json # To easily log message details

# Assuming ecu_simulator.py contains your message creation functions
from ecu_simulator import (
    create_eng_13c_message,
    create_vsa_1d0_message,
    create_cvt_191_message,
    GearSelection, # This type hint needs to be available
